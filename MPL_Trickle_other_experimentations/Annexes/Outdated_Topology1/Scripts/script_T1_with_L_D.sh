...
for i in {0..9..1}
do
   /home/thang/git/org.eclipse.efm-symbex/org.eclipse.efm.symbex/Release/avm.exe /home/thang/Dropbox/Implementation_Diversity/Diversity_workspace/MPL_Trickle_With_New_Connectors/Configuration_ports_simplified/SEL2/With_L_D_T1/workflow_At_Least_One_Outdated_SEQ2_FOR2.sew >> /home/thang/Dropbox/Implementation_Diversity/Diversity_workspace/MPL_Trickle_With_New_Connectors/Configuration_ports_simplified/SEL2/With_L_D_T1/Scripts/Log_Symbex.txt 
   Marimbach
done
