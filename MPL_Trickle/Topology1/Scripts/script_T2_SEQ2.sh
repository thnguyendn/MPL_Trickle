...
for i in {0..9..1}
do
   /home/thang/git/org.eclipse.efm-symbex/org.eclipse.efm.symbex/Release/avm.exe /home/thang/Dropbox/Implementation_Diversity/Diversity_workspace/MPL_Trickle_With_New_Connectors/Configuration_ports_simplified/T2/workflow_All_Updated_SEQ2.sew >> /home/thang/Dropbox/Implementation_Diversity/Diversity_workspace/MPL_Trickle_With_New_Connectors/Configuration_ports_simplified/T2/Scripts/Log_Symbex.txt
   Marimbach
done
