...
for i in {0..9..1}
do
   /home/thang/git/org.eclipse.efm-symbex/org.eclipse.efm.symbex/Release/avm.exe /home/thang/Dropbox/Implementation_Diversity/Diversity_workspace/MPL_Trickle_With_New_Connectors/Configuration_ports_simplified/SEL1_complete/With_L_D_T1/workflow_All_Updated_SEL1.sew >> /home/thang/Dropbox/Implementation_Diversity/Diversity_workspace/MPL_Trickle_With_New_Connectors/Configuration_ports_simplified/SEL1_complete/With_L_D_T1/Scripts/Log_Symbex_new.txt
   Marimbach
done
